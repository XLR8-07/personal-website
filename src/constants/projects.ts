...
export const PROJECTS: Project[] = [
    {
        title: 'FracAtlas',
        imgSrc: 'images/projects/fracatlas_thumbnail.png',
        technologies: [ 'Python', 'OpenCV', 'PyTorch'],
        shortDescription: 'Detect Fracture from X-ray images in real time',
        longDescription: `This project is a companion to the FracAtlas dataset published for research purposes. It focuses on developing\nand implementing algorithms that can localize and segment potential bone fracture areas in X-ray images. `,
        githubLink: 'https://github.com/XLR8-07/FracAtlas',
        liveLink: 'https://github.com/XLR8-07/FracAtlas'
    },
    {
        title: 'M.I.D.A.S',
        imgSrc: 'images/projects/midas_thumbnail_2.png',
